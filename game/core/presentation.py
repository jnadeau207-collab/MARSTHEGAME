...
class PresentationDirector:
        ...
        self.event_log.append(
            {
                ...
                "shake": shake * strength * self.accessibility["screen_shake"],
            }
        )
    ...
    def observe(self, scene: Any) -> None:
        ...
        if camera is not None and self.event_log:
            shake = self.event_log[-1]["shake"]
            if shake > 0 and hasattr(camera, "add_shake"):
